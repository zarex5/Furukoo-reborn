...
export function PlayersBox({ users, myUsername, gamePlayers, onSpectate, mobile = false }: PlayersBoxProps) {
  ...
  const header = (
    <div className="grid grid-cols-[1fr_3rem_2rem] text-xs font-bold px-2 py-2 bg-slate-50 dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700 text-slate-500 dark:text-gray-400 flex-none">
      <span>Players</span>
